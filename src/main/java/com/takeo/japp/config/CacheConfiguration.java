...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.takeo.japp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.takeo.japp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
